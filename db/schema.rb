...
ActiveRecord::Schema.define(version: 20150501010319) do
  ...
  add_index "statuses", ["post_id"], name: "index_statuses_on_post_id", using: :btree
  ...
  add_foreign_key "posts", "posts", column: "posting_id"
